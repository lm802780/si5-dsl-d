...
const poly_arduino_module_1 = require("../language-server/poly-arduino-module");
const cli_util_1 = require("./cli-util");
const generator_1 = require("./generator");
const node_1 = require("langium/node");
const generateAction = (fileName, opts) => __awaiter(void 0, void 0, void 0, function* () {
    const services = (0, poly_arduino_module_1.createPolyArduinoServices)(node_1.NodeFileSystem).PolyArduino;
...
function default_1() {
    ...
    const fileExtensions = module_1.PolyArduinoLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
